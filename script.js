...
/* SCROLL REVEAL EFFECTS (keeps a gentle, professional motion) */
if (typeof ScrollReveal !== 'undefined') {
  ScrollReveal({
    ...
    delay: 120,
    reset: false
  }).reveal('.home-inner, .section-title, .card, .edu-list li, .cert-list li, .contact-card, .contact-form', { interval: 80 });
}
